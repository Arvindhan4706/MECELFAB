                ...
                <div className="flex flex-col gap-3">
                  {section.items.map((item) => (
                    <div key={item.name} className="flex items-center justify-between p-4 bg-black/30 border border-white/5 group hover:border-white/15 transition-colors duration-300">
                      ...
                      {item.available ? (
                        <button className="flex items-center gap-2 text-[10px] font-heading tracking-widest uppercase text-white/40 hover:text-white transition-colors px-3 py-2 border border-white/10 hover:border-white/30">
                          <Download size={12} />
                          Download
                        </button>
                      ) : (
                        <span className="text-[10px] font-heading tracking-widest uppercase text-white/20 px-3 py-2">
                          Coming Soon
                        </span>
                      )}
                    </div>
